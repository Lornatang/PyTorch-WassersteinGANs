...
from wassersteinGANs.model.dcgan import Discriminator
from wassersteinGANs.model.dcgan import Generator
from wassersteinGANs.model.dcgan import weights_init
...
def generate():
  ...
  print(f"Load model...\n")
  if torch.cuda.device_count() > 1:
    netG = torch.nn.DataParallel(Generator(ngpu=opt.ngpu))
  else:
